	...
	<main role="main" class="container">
		...
		<div class='card'>
			...
			<div class='card-footer'>
			    <form method="post" action="ExecuteDeleteArticoloServlet" novalidate="novalidate">
			  	   <input type="hidden" name="idArticoloDelete" value="<%= articoloInPagina.getId() %>">
				    <button type="submit" name="submit" value="submit" id="submit" class="btn btn-danger btn-sm">Elimina</button>	
				    <a href="ListArticoliServlet" class='btn  btn-sm btn-outline-secondary'>
